...
import avatarImg from "../../assets/sandhya.jpg"; 
...
const Navbar = () => {
  ...
  return (
<nav className="flex flex-wrap justify-between items-center text-white px-4 md:px-4 pt-4">
      <div className="flex items-center">
        <img src={avatarImg} alt="Profile" className="h-12 w-12 rounded-full mr-4" />
        <span className="text-xl font-bold tracking-wide">Sandhya Portfolio</span>
      </div>
      <ul
